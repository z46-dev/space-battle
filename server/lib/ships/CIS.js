...
ships.LUPUSMISSILEFRIGATE = {
    ...
    hardpoints: [{
        ...
        weapon: {
            ...
            health: DOUBLE_ION_CANNON_MEDIUM.health * 3,
            reload: DOUBLE_ION_CANNON_MEDIUM.reload * .6
        },
        shotsAtOnce: 2,
        shotDelay: 100
    }, {
        ...
        weapon: {
            ...
            health: ASSAULT_CONCUSSION_MISSILE.health * 3,
            reload: ASSAULT_CONCUSSION_MISSILE.reload * .8
        },
        shotsAtOnce: 6,
        shotDelay: 120
    }, {
        ...
        weapon: {
            ...
            health: ASSAULT_PROTON_ROCKET.health * 3,
            reload: ASSAULT_PROTON_ROCKET.reload * .8
        },
        shotsAtOnce: 4,
        shotDelay: 120
    }]
