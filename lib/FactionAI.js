    ...
    planExpand(info) {
        ...
        return {
            ...
            execute: () => {
                ...
                if (choice.attacking.controllingFaction === this.campaign.playerFaction) {
                    this.campaign.log.battlePending(this.campaign.week, `Invasion of ${choice.attacking.name} imminent!`);
                }
