...
export const oldRepublic = new FactionConfig("Old Republic", "#25BEEE", "OLDREP")
    ...
    .addStationOptions("DARKNON_OLDREP", "RONIKA_OLDREP", "KEMPLEX_OLDREP")
    .addShipyardOptions("SHIPYARD_LVL_1_OLDREP", "SHIPYARD_LVL_2_OLDREP", "SHIPYARD_LVL_3_OLDREP", "SHIPYARD_LVL_4_OLDREP");
...
export const sithEmpire = new FactionConfig("Sith Empire", "#EEA5A5", "SITHEMP")
    ...
    .addStationOptions("SITH_RELAY_SITHEMP", "RONIKA_SITHEMP", "KEMPLEX_SITHEMP")
    .addShipyardOptions("SHIPYARD_LVL_1_SITHEMP", "SHIPYARD_LVL_2_SITHEMP", "SHIPYARD_LVL_3_SITHEMP", "SHIPYARD_LVL_4_SITHEMP");
...
export const mandalorians = new FactionConfig("Mandalorians", "#EEBE55", "MANDO")
    ...
    .addStationOptions("DARKNON_MANDO", "RONIKA_MANDO", "KEMPLEX_MANDO")
    .addShipyardOptions("SHIPYARD_LVL_1_MANDO", "SHIPYARD_LVL_2_MANDO", "SHIPYARD_LVL_3_MANDO", "SHIPYARD_LVL_4_MANDO");
